    ...
    <a-row>
      ...
      <a-col :xs="24" :sm="24" :md="8" :lg="8">
        <description-item
          ...
          :content="`${tour.number_persons} người`"
        />
      </a-col>
      <!-- <a-col :xs="24" :sm="24" :md="8" :lg="8">

  ...
  <a-card :bordered="false" :bodyStyle="{ padding: '16px' }">
    ...
    <div class="form-group">
      ...
      <div class="form-input">
        <a-radio-group
          :value="$route.query.category ? $route.query.category + '' : '0'"
          buttonStyle="solid"
    ...
    <div class="form-group">
      ...
      <div class="form-input">
        <a-select
          placeholder="Nơi đến"
          style="width: 100%"
          :value="$route.query.toPlace || undefined"
          @change="onChangeToPlace"
        >
          <a-select-option
    ...
    <div class="form-group">
      ...
      <div class="form-input">
        <a-select
          ...
          :value="$route.query.depart || undefined"
          style="width: 100%"
    ...
    <div class="form-group">
      ...
      <div class="form-input">
        <a-checkbox
          ref="featured"
          :checked="!!$route.query.featured || false"
          @change="onChangeFeatured"
          >Nổi bật</a-checkbox
        >
      </div>
    </div>

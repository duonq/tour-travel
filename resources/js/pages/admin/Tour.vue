      ...
      >
        ...
        <template slot="code" slot-scope="record">
          <a-tooltip placement="top" title="Click để xem chi tiết">
            <a class="color-code" @click="onPreview(record.id)"
              >{{ record.code }}</a
            >
          </a-tooltip>
        </template>
            ...
            <a-row :gutter="16" :style="{ marginTop: '24px' }">
              <a-col :span="6">
                <a-form-item
                  ...
                  :labelCol="{ span: 12 }"
                >
                  <a-switch v-decorator="['is_featured']" v-model="isFeatured">
                  </a-switch>
                </a-form-item>
              </a-col>
              <a-col :span="6">
                <a-form-item
                  ...
                  :labelCol="{ span: 12 }"
                >
                  <a-switch v-decorator="['is_active']" v-model="isActive">
                  </a-switch>
                </a-form-item>
              </a-col>
            </a-row>
